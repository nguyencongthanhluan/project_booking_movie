...
import "./../MovieScheduleItem/movieScheduleItem.scss";
        ...
        return (
          <div key={index} className="slide">
            <div className="member_intro intro_1">
              ...
              <div className="intro_center"></div>
              ...
              <div className="nameFilm">
                ...
                <Link
                  ...
                  className="button_muave btn btn-success"
                >
                  MUA VÉ
                </Link>
              </div>
    ...
    return (
      <div>
        ...
        <div style={{ textAlign: "center" }}>
          <button
            className="button_previous button_item"
